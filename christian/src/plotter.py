    ...
    def plot_scatter_plots(self):
        for e in range(1):
            for b in range(100):
                ...
                scatter_plot(train_type="sup", weights=weights, lr=0.0001, batch=b, epoch=e, loc=self.scatter_plots_dir)
    ...
    def combine_plots(self):
        for index in range(0, 151):
            if index == 0:
                ...
                b = f"../whole_plots/scatter_plots/unsup, every batch/unsup lr = 0.0001, 0 {index-1}.png"
...
class Slow_lr_Freq_Plotter(ParentPlotter):
    def __init__(self):
        ...
        self.scatter_plots_dir= "../whole_plots/scatter_plots/slow_lr_freq"
...
class Fast_lr_Freq_Plotter(ParentPlotter):
    def __init__(self):
        ...
        self.scatter_plots_dir= "../whole_plots/scatter_plots/fast_lr_freq"
        self.is_control = False
...
class Slow_lr_Size_Plotter(ParentPlotter):
    def __init__(self):
        ...
        self.scatter_plots_dir= "../whole_plots/scatter_plots/slow_lr_size"
...
class Fast_lr_Size_Plotter(ParentPlotter):
    def __init__(self):
        ...
        self.scatter_plots_dir= "../whole_plots/scatter_plots/fast_lr_size"
        self.is_control = True
