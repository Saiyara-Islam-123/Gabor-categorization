...
def train_supervised(model, trainloader, device, lr, epochs=15, dist_func = sampled_all_distance):
    """
    ...
    for epoch in range(epochs):
        ...
        for images, labels in trainloader:
            ...
            torch.save(model.state_dict(), f"../net_weights/sup_xab_dataset/sup_net_weights_ lr={lr} "+str(epoch)+  " " + str(batch) +".pth")
    ...
    df.to_csv(f"LR={lr}, XAB Distance every batch sup, epochs.csv", index=False)
